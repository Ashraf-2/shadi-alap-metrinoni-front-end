...
const FreeBacgroundImage = ({ imgLink, backgroudText }) => {
    ...
    return (
        <div style={{ backgroundImage: `url(${imgLink})`, backgroundRepeat: 'no-repeat', backgroundSize: 'cover', backgroundPosition: 'center' }} className="bg-fixed min-h-[60vh] md:min-h-[80vh] w-full mx-auto object-fill flex flex-col items-center justify-center">
