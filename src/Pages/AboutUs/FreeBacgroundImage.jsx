...
const FreeBacgroundImage = ({ imgLink, backgroudText }) => {
    ...
    return (
        <div style={{ backgroundImage: `url(${imgLink})`, backgroundRepeat: 'no-repeat', backgroundPosition: 'center', backgroundSize: 'cover' }} className="bg-fixed min-h-[60vh] w-full mx-auto object-fill flex flex-col items-center justify-center">
